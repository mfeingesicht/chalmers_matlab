...
%NEW
    ...
    %Uses : bike_model_v1_20190524_oldmodel_positionfeedback_Nobalancing.slx
...
time_change_vel=40;         %time at which velocity changes
    for i = 1: time_change_vel       % first part velocity
        input_velocity=2.5;            % [m/s]   forward velocity
    end
...
noise_pos_meas=0.01;  %0.51 or 9 % variance of position measurement system
...
Q_kalman = [0.01 0 0 0 ;0 0.01 0 0; 0 0 0.01 0; 0 0 0 0.01];                 % Process noise covariance
...
path=4;      % 1: Straight Path --   2: Circle       3:_/-       4: ___O___
...
try sim('bike_model_v1_20190524_positionfeedback_Nobalancing.slx')
