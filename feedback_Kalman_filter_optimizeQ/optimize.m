...
Q_kalman = [0.001 0 0 0 ;0 0.001 0 0; 0 0 0.001 0; 0 0 0 0.001];                 % Process noise covariance
...
% % X0 = [1 1 1 1];
% % X0 = [17.6799   16.2857   19.2380    4.6956];
% X0 = [    2.1112   15.7896   12.5981   17.6154];
X0 = [   17.6799   16.2857   19.2380    4.6956];
...
XQ = ga(@objfunc,4,[],[],[],[],[0 0 0 0],[],[],[],ga_options)
Q11 = XQ(1);
Q22 = XQ(2);
Q33 = XQ(3);
Q44 = XQ(4);
...
% 
% XQ = fmincon(@objfunc,X0,[],[],[],[],[0 0 0 0],[],[],fmincon_options)
% Q11 = XQ(1);
% Q22 = XQ(2);
% Q33 = XQ(3);
% Q44 = XQ(4);
