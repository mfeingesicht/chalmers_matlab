...
filename = 'currentControl/freq0.500000_amplitude0.600000_20200310-113525.csv';
filename = 'currentControl/freq1.000000_amplitude0.600000_20200310-104222.csv';
filename = 'currentControl/freq2.000000_amplitude0.600000_20200310-113328.csv';
filename = 'currentControl/freq5.000000_amplitude0.600000_20200310-113354.csv';
filename = 'currentControl/freq10.000000_amplitude0.800000_20200310-171216.csv';
filename = 'currentControl/freq20.000000_amplitude0.800000_20200310-171730.csv';

data = csvread(filename,2);

t = regexp(filename,'\d+\.?\d*','match');
amplitude = str2double(t{2});
omega = 2*pi*str2double(t{1});
...
%% Plot data
figure;plot(time,current);title('Reference Current (Input)');
figure;plot(time,delta);title('Measured Steering Angle (Output)');


%% Preprocess data
% Remove start of dat to wait for motor to warm up
% if strcmp(filename,'Kp416_Ti67/freq010.000000_amplitude0.017444.csv')
...
% Detrended Lissajou figure (from dentrended identified model : a = 0, b = 0)
