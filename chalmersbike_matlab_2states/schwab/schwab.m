...
schwab_matlab_block
h = h_astrm; % height of center of mass [m]
b = b_astrm;            % length between wheel centers [m]
...
a = a_astrm;           % distance from rear wheel to frame's center of mass [m]
IMU_height = 0.45;    % IMU height [m]
g = 9.81;             % gravity [m/s^2]
m = mb+mr+mh;               % Bike mas [kg]
