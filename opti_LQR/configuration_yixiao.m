...
h_real = 0.5195;             % height of center of mass [m]
...
h_box_real = 0.8010;         % height of box's center of mass [m]  
...
enable_bias = 0;
m_box_bias = m_box_real * 0.3;
d_box_bias = c_box_real * 0.25;
...
if enable_bias == 1
    parameters_f_b_real = [m_frame_real m_box_real h_frame_real h_box_real a_frame_real a_box_real c_frame_real...
        c_box_real b_frame_real b_box_real l_frame_real l_box_real m_box_bias d_box_bias];
else
    parameters_f_b_real = [m_frame_real m_box_real h_frame_real h_box_real a_frame_real a_box_real c_frame_real...
        c_box_real b_frame_real b_box_real l_frame_real l_box_real];
end
...
% Steering control
P_steer = 0.4;    % Steering control P gain
I_steer = 0.3;  % Steering control I gain
