...
R = 20;                 % cost of inputs in LQR controller  
...
x_ini_diff=0;
y_ini_diff=0;
path=7;      % 1: Straight Path --   2: Circle       3:_/-       4: ___O___
...
% SETTING PLOTS
Bike_animation=1;              %Set to 1 to see bike animation (path and 3D simulation
...
if Bike_animation==1
    ...
    if path_tracking==1
        ...
        %3D simulation
            ...
            %tic    
            if k == 1
                 b = bike3D190215();    %Generates the bike 3Dsimulation 
            end
...
if States_Plot==1
    ...
    ylabel('Roll Angle [rad]','FontSize',font_size)
    subplot(4,1,2)
    ...
    ylabel('Steering Angle [rad]','FontSize',font_size)
    subplot(4,1,3)
